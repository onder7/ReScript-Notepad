...
function blit(a1, ofs1, a2, ofs2, len) {
  var lena1 = a1.length;
  var lena2 = a2.length;
  var srcofs1 = ofs1 < 0 ? int_max(lena1 + ofs1 | 0, 0) : ofs1;
  var srcofs2 = ofs2 < 0 ? int_max(lena2 + ofs2 | 0, 0) : ofs2;
  var blitLength = int_min(len, int_min(lena1 - srcofs1 | 0, lena2 - srcofs2 | 0));
  if (srcofs2 <= srcofs1) {
    for (var j = 0; j < blitLength; ++j) {
      a2[j + srcofs2 | 0] = a1[j + srcofs1 | 0];
    }
...
function flatMap(a, f) {
  return concatMany(mapU(a, __1(f)));
}
function getByU(a, p) {
  var l = a.length;
  var i = 0;
...
function reduceReverse2U(a, b, x, f) {
  var r = x;
  var len = int_min(a.length, b.length);
...
function every2U(a, b, p) {
  return everyAux2(a, b, 0, p, int_min(a.length, b.length));
}
...
//# sourceMappingURL=rescript_lib_es6_belt_Array__js.js.map
